...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $defaultSettings = [
            ...
            'site_logo_secondary_1' => null,
            'site_logo_secondary_2' => null,
            ...
            'about_header_title' => 'Tentang Kami',
            'about_header_subtitle' => 'Mengenal lebih dekat visi, sejarah, dan nilai-nilai yang kami usung.',
            'about_section_badge' => 'Profil Kami',
            'about_section_main_heading' => 'Menyajikan Informasi yang Akurat, Edukatif, dan Menginspirasi',
            'about_paragraph_1' => 'Kami adalah portal artikel independen yang berdedikasi untuk membagikan wawasan terbaru dan tepercaya kepada masyarakat umum. Kami percaya bahwa pengetahuan adalah kekuatan, dan akses terhadap informasi yang berkualitas harus mudah dijangkau oleh semua orang.',
            'about_paragraph_2' => 'Setiap artikel yang diterbitkan melalui platform kami melewati proses tinjauan internal oleh tim admin kami untuk memastikan konten yang disajikan memiliki nilai edukasi, keakuratan data, serta penyampaian yang mudah dipahami.',
            'about_pillar_1_icon' => 'fa-solid fa-circle-check',
            'about_pillar_1_title' => 'Konten Akurat',
            'about_pillar_1_description' => 'Informasi yang kami bagikan berbasis data tepercaya.',
            'about_pillar_2_icon' => 'fa-solid fa-bolt',
            'about_pillar_2_title' => 'Pembaruan Cepat',
            'about_pillar_2_description' => 'Selalu menyajikan tren terhangat secara realtime.',
            'about_card_title' => 'Sejarah Singkat',
            'about_card_description' => 'Didirikan sebagai wadah berbagi bagi para penulis dan pemerhati isu-isu sosial, teknologi, serta kesehatan, platform ini terus berkembang menjadi portal rujukan ribuan pembaca setiap bulannya.',
            'about_card_icon' => 'fa-solid fa-graduation-cap',
            'about_card_stat_1' => 'Mulai Sejak 2026',
            'about_card_stat_2' => '10,000+ Pembaca Bulanan',
            'about_card_image' => null,
        ];
